...
import { ApprovalMode } from '@perplexity-cli/perplexity-cli-core';
import {
...
export const InputPrompt: React.FC<InputPromptProps> = ({
  ...
  const promptRail = '━'.repeat(Math.max(24, inputWidth + 14));

  return (
    <>
      <Box flexDirection="column" width="100%">
        <Text color={theme.border.default}>{promptRail}</Text>
        <Box paddingX={0}>
          <Text
            color={statusColor ?? theme.text.link}
