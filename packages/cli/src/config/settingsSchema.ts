    ...
    properties: {
      ...
      language: {
        ...
        description:
          ...
          'in ~/.perplexity/locales/ (e.g., ~/.perplexity/locales/es.js).',
        showInDialog: true,
        options: [
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Perplexity CLI status and thoughts in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (PERPLEXITY.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  model: {
    ...
    properties: {
      name: {
        ...
        requiresRestart: false,
        default: undefined as string | undefined,
        description: 'The Perplexity model to use for conversations.',
        showInDialog: false,
      },
      maxSessionTurns: {
        type: 'number',
      ...
      generationConfig: {
        ...
        properties: {
          ...
          disableCacheControl: {
            ...
            requiresRestart: false,
            default: false,
            description: 'Disable cache control for Perplexity providers.',
            parentKey: 'generationConfig',
    ...
    properties: {
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectPerplexityIgnore: {
            type: 'boolean',
            label: 'Respect .perplexityignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .perplexityignore files when searching',
            showInDialog: true,
          },
      ...
      auth: {
        ...
        properties: {
          ...
          sessionToken: {
            ...
            default: undefined as string | undefined,
            description:
              'Perplexity web session token (__Secure-next-auth.session-token cookie). When set, uses web interface instead of API key.',
            showInDialog: false,
          },
          baseUrl: {
            type: 'string',
  ...
  experimental: {
    ...
    properties: {
      ...
      visionModelPreview: {
        ...
        default: true,
        description:
          'Enable vision model support and auto-switching functionality. When disabled, vision models like perplexity-vl-max-latest will be hidden and auto-switching will not occur.',
        showInDialog: true,
      },
      vlmSwitchMode: {
        type: 'string',
